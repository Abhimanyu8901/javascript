...
<section class="page-hero">
  <div class="page-hero-card">
    ...
    <p class="page-lead">This frontend registration page collects the exact details you asked for: blood group, city, availability, and contact preference.</p>
  </div>
</section>
  ...
  <div class="section-inner split-grid">
    <div class="stack">
      <article class="card">
        ...
        <h3>Designed to feel serious, caring, and easy to trust.</h3>
        <ul class="list-clean">
      ...
      <article class="card">
        ...
        <p>Frontend-only preference controls are included now so the eventual backend can plug into a ready-made UI.</p>
      </article>
    </div>
    <div class="form-card">
